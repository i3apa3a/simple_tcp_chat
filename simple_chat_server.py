...
def parsing_from_cl():
    import argparse
    parser = argparse.ArgumentParser(description='This is a simple chat (server side).')
    ...
    return args.ip, args.port, args.bsize, args.color
...
if __name__=='__main__':
    tcp_ip, tcp_port, buffer_size, is_color = parsing_from_cl()
    start_server(tcp_ip, tcp_port, buffer_size, is_color)